1) Important point for using Next.js  than react is Server side Rendering 

IN react all the HTML and bulk JS file loaded in the client not on server so the website is not fast
